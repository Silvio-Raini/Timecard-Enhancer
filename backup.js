function calcFeierabend() {
  ...
  var anwesenheitElement= document.getElementById('totaltime');
  ...
  if (comeTimeElement && pauseTimeElement && gleitzeitTimeElement && tableBody) {
    ...
    var curTime = anwesenheitElement.getAttribute('title');

    if (comeTime && pauseTime && gleitzeitTime && curTime) {
      ...
      readData()
        .then((data) =>  {
          ...
          console.log('Anwesenheit = AW:'+curTime);
